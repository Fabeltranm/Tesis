...
\setlength{\parskip}{0.2ex} 	% separación entre parrafos se aumenta
...
\usepackage{titlesec} 	% Cambia el formato de lso  titulos
			...
			% \chaptertitlename, -> \chaptername ("CapÃ­tulo")
			% o  a \apendixname ("ApÃ©ndice")
...
%% inclusión del paquete glossaries, para  tener lso acronimos
%	xindy 	indica que el motor de  busqueda es xindy, se necesita del  la instalacion de xindy
%	acronym, indica que se genera lista de acronimos
...
% la forma corta las siguentes 	\ac1 muestra la  forma larga del acrónimo
...
% configuraciòn de comentarios y cosas por hacer
