...
la \acf{AF}. Para entender los mecanismos que dan lugar a las \ac{VF} y \ac{AF},
en la literatura se exponen un gran número de sistemas que modeladan diversas
aproximaciones para simulan la propagación del estímulo cardiaco.




Por lo tanto, el registro de la actividad eléctrica, mediante sistemas de
electrodos intracardiacos \ac{EGM} o en la superficie del corazón \ac{ECG},
