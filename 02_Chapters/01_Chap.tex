...
\begin{resumen}
  ...
  descripción del módelo \ac{AC} propuesto en \cite{Alonso-Atienza05},
...
despolarización de las células cardiacas, y  propagada por el miocardio, a través del sistema de conducción del corazón.
...
medio del autómata celular, que se conecta con 4 vecinos, la vecinda  tiene forma de cruz  y esta commpuesta por 5 celdas. (c) representación de la
...
como un sistema compuesto por tres medios continuos \cite{holden1997}, el medio intrecelular, el
medio extracelular y la membrana celular. lo que conlleva a representar las
celulas electrofisiológicas con la aproximación de dos modelos el modelo bidominio y el modelo momodominio.
...
de una céula a otra, a través del medio intracelular (debido a las uniones
