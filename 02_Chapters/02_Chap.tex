...
indicar en que publicación esta esta descripción 
...
multivariantes, en tiempo y espacio. De esta manera, se puede estudiar cómo se
comportan señales variantes en el tiempo, que de otra forma, serian muy dificil
tratar, si no es por herramientas estadisticas.

Las señales aleatores, en los procesos estocasticos de segundo orden, se
analizan por medio de la distribución de potencia en frecuencia y de la
autocorrelación de la señal.  Por esto, que los procesos estocásticos de
segundo orden, son una de las técnicas matemáticas más utilizadas para 
describir las señales bioélectricas, ya que para este tipo de variables,  soló
se dispone de un segmento finito de la señal y por lo tanto es necesario acudir
a técnicas de estimación espectral.


El espectro en potencia, de la señales bioelectricas y, en general de las
señales discretas que sólo se puede analizar e un tiempo finito,se define en
función del módelo estocastico como la transformada de Fourier de la función de
autocorrelación.
