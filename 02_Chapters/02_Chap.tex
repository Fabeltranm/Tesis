...
En de señales biolectricas, y en general en señales discretas que se analizan 
en un tiempo finito, el análisis espectral se realiza en función
de los modelo estocástico. Es asi como el espectro en potencia se define como
la transformada de Fourier de la función de autocorrelación\cite{Papoulis91}.


colocar aca la funcion de espectro y de autocorrelación genérica



aca hablar de \cite{Papoulis91},

\subsection{Correlación Señal}
