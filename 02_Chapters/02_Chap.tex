...
estudio del espectro de las señales cardiacas de esta \nombreDoc, y el cual se
encuentra en la publicación \cite{Requena13b}. El objetivo del capítulo es
desarrollar  la teoría que conecta el espectro de la señales cardiacas, con su
dinámica espacio-temporal de las señales cardiacas. Así mismos, se abordan los
efectos de sistemas de electrodos sobre el espectro de las señales. Por lo
tanto, los resultados teóricos, presentes en este capitulo, derivan  en el
análisis e interpretación del espectro de señales cardiacas, que se abordad en el próximo capítulo

La relación entre los diferentes sistemas de medida de señales cardiacas y los
espectros de las mismas, se abordar a partir del análisis de señales
multivariantes junto con módelos bioeléctricos. 

We analyze the spectral manifestation of cardiac rhythms and the spectral
effects of lead systems.
We relate analytically c

A su vez, se definen mapas de autocorrelación para las fuentes  y señales 
bioeléctricas, de esta forma, de acuerdo con la correlación espacio-temporal,
se clasifican las diferentes dinàmicas cardiacas, en perfectamente
correlacionandas, parcialmente correlacionadas  y perfectamente incorrelacionadas. A si mismo, se abordan los
...
medida del grado de correlación espacio temporal

tesis de jesus  en resumen  y lo del articulo la parte teórica

llega hasta la descrip la correlación de voltajes  definicion de tipos de
